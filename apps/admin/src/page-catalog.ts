...
export const adminPageCatalog: AdminPageSpec[] = [
  ...
  },
  {
    ...
    fields: ["门店编号", "门店名称", "所属商户", "城市", "WiFi 状态", "二维码状态"],
    actions: ["新增", "编辑", "配置 WiFi", "生成二维码", "修改分成比例"],
    highRiskActions: ["修改分成比例"],
    emptyState: "暂无门店",
  },
  {
    path: "/admin/wifi",
    ...
    fields: ["门店", "商户", "SSID", "密码脱敏", "加密类型", "连接模式", "启用状态"],
    actions: ["新增", "编辑", "禁用", "重置密码", "复制密码"],
    highRiskActions: ["禁用", "重置密码", "复制密码"],
    emptyState: "未配置",
  },
  {
    path: "/admin/wallets",
